...
{
	[AddComponentMenu("Crazy Minnow Studio/SALSA/Addons/micInput")]
	public class CM_MicInput : MonoBehaviour
	{

		// RELEASE NOTES:
		//			1.7.0 (BETA)
		//				  ~ Introduced a micro-delay in Wireup(), to give Unity
		//						Microphone systems time to spin up, reducing
		//						startup latency.
		//				  ~ Move component menu item under SALSA / Addons.
