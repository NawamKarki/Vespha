...
public class OVRPlayerController : MonoBehaviour
{
	...
	{
        //OVRInput.Update();
        //if (Input.GetKeyDown(KeyCode.Joystick1Button8) || Input.GetKeyDown(KeyCode.Joystick1Button1) || Input.GetKeyDown(KeyCode.Joystick1Button2)){
        //    Debug.Log("playing with a controller");
        //}
        //else if (Input.GetAxis("Mouse X") != 0F || Input.GetAxis("Mouse Y") != 0F || Input.GetKeyDown(KeyCode.W) || Input.GetKeyDown(KeyCode.A)){
        //    Debug.Log("playing with mouse & keyboard");
        //}
